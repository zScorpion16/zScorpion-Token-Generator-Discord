...
N = input("『♱』¿Cuantos Tokens A Generar?")
count = 0
    ...
    for token in tokens:
        ...
        try:
            ...
            if r.status_code == 200:
                print(u"\u001b[32;1m 『♱』¡El Token Funciona Correctamente!\u001b[0m")
                f = open(current_path+"/"+"workingtokens.txt", "a")
                f.write(token+"\n")
            elif "rate limited." in r.text:
                print("『♱』¡Tienes Una Tarifa Limitada A Elegir!")
            else:
                print(u"\u001b[31m『♱』¡Token Invalido!\u001b[0m")
